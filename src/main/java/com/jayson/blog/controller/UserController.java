...
import com.jayson.blog.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<UserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ...
        // 获取用户登录 ip 地址
        String loginUserIp = userService.getIpAddr(request);
        System.out.println(loginUserIp);
    ...
    public BaseResponse<UserVO> backendLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        if (userLoginRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        String userAccount = userLoginRequest.getUserAccount();
    ...
    public BaseResponse<UserVO> getUserById(int id, HttpServletRequest request) {
        ...
        // 转换时间格式
        String finalLoginTimeStr = sdf.format(user.getFinallLoginTime());
        String createTimeStr = sdf.format(user.getCreateTime());
        String updateTimeStr = sdf.format(user.getUpdateTime());
        UserVO userVO = new UserVO();
        BeanUtils.copyProperties(user, userVO);
        userVO.setFinallLoginTime(finalLoginTimeStr);
        userVO.setCreateTime(createTimeStr);
        userVO.setUpdateTime(updateTimeStr);
        return ResultUtils.success(userVO);
    }
